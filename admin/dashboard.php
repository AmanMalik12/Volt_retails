...
<body>
    ...
    $sql = "SELECT * FROM inquiryProduct WHERE queryId NOT IN (SELECT * FROM checkInquery)";
    ...
    <div class="container">
        <div class="center">
            <a  href="page.php?pid=upload" class="button-52" type="button" role="button">Upload New Products</a>
        </div>
    </div>
